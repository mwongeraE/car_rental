...
public class VerifyMobile extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!(bundle == null)) {
			...
			//is my param for test cognalys
			test_mode = bundle.getBoolean("test_mode");
			...
			if(CheckNetworkConnection.isConnectionAvailable(VerifyMobile.this)){
				...
				Toast.makeText(VerifyMobile.this,"No Internet Connection",Toast.LENGTH_SHORT).show();
				ExitThread thread=new ExitThread();
				thread.start();
			}
		} else {
